...
/* Definitions for myBinarySemAnalaog */
osSemaphoreId_t myBinarySemAnalaogHandle;
const osSemaphoreAttr_t myBinarySemAnalaog_attributes = {
  .name = "myBinarySemAnalaog"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* creation of myBinarySemAnalaog */
...
/* USER CODE BEGIN Header_AnalogInput */
/**
